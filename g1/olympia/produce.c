...
terr_prod[] =
{
	...
	{sub_plain,		item_wild_horse,	3},
	{sub_pasture,		item_wild_horse,	3},
...
start_generic_mine(struct command *c, int item)
{
	...
	{
		wout(c->who, "Must be in a mine to extract %s.",
					just_name(item));
		return FALSE;
	}
...
harv_tbl[] = {
	...
	"Peasants must be recruited in provinces.",
	"recruit peasants",
	TRUE
    },
    {
